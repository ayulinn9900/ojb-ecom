            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.products.index') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('Kembali ke Products') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="description" rows="3" class="form-control summernote">{!! old('Spesifikasi Produk', $product->description) !!}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="details" rows="3" class="form-control summernote">{!! old('Deskripsi Produk', $product->details) !!}</textarea>
